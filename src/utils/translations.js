...
const translations = {
  ...
  sk: {
    ...
    homeText: {
      p1: `Zahlcujú vaše podnikanie administratívne úlohy? Je pre vás náročné držať krok s kontrolami a aktualizáciami údajov, 
      údržbou poštových schránok a sociálnymi médiami? Už nehľadajte! Som tu, aby som vám poskytol správne riešenia, ktoré posunú vašu firmu správnym smerom.`,
      p2: `Rozumiem výzvam, ktoré so sebou prináša podnikanie. Viem, že váš čas je cenný a mali by ste ho venovať kľúčovým činnostiam, 
      ktoré podporujú rast. Tu prichádza na rad váš virtuálny asistent.`,
      p3: `So svojimi odbornými znalosťami ako virtuálny asistent sa špecializujem na vybavovanie administratívnych úloh, ktoré zaisťujú, 
      aby vaša firma fungovala hladko a efektívne. Potrebujete niekoho, kto by starostlivo skontroloval a aktualizoval vaše údaje? Mám vás k dispozícii. 
      Už vás nebaví žonglovať s viacerými poštovými schránkami a snažiť sa udržať si prehľad o otázkach zákazníkov? Nechajte to na mňa. 
      Chcete si vybudovať silnú online prítomnosť prostredníctvom sociálnych médií, ale chýba vám to?`,
      p4: `Ale som viac než len poskytovateľ riešení. Som váš oddaný partner v úspechu. Keď budete so mnou spolupracovať, 
      získate prístup k niekomu, komu na vašom podnikaní skutočne záleží. Venujem čas tomu, aby som pochopil vaše jedinečné potreby, 
      ciele a identitu značky a zabezpečil, že moje služby budú dokonale zodpovedať vašej vízii.`,
      p5: `Predstavte si, že máte viac času a pokoja s vedomím, že vaše administratívne úlohy sú vybavované bezchybne. 
      Predstavte si, že vaše podnikanie prekvitá, keď odborne spravujem vaše údaje, udržiavam vaše poštové schránky organizované a vytváram pútavý obsah sociálnych médií.`,
      p6: `Takže, ste pripravení posunúť svoje podnikanie do nových výšin? Vydajme sa na túto cestu spoločne. 
      Kontaktujte ma ešte dnes a porozprávajme sa o tom, ako môžu moje riešenia na mieru posunúť vaše podnikanie vpred. 
      Váš úspech je mojou vášňou a nemôžem sa dočkať, až budem toho súčasťou.`,
    ...
    homeCarouselDescription1: `Som neochvejný vo svojom záväzku k dokonalosti a neustále sa snažím zabezpečiť, aby vaše úlohy boli dokončené nielen včas, ale aj precízne. 
    Môžete sa na mňa spoľahnúť, že dosiahnem vynikajúce výsledky a nenechám priestor na pochybnosti alebo sklamanie.`,
    homeCarouselTitle2: "Nezávislosť",
    homeCarouselDescription2: `Prijímajúc večnú cestu sebazdokonaľovania, neustále sa zapájam do vzdelávania a navštevujem kurzy, aby som si zdokonalil svoje zručnosti. 
    Moja starostlivá pozornosť venovaná detailom zabezpečuje komplexný a dôkladný prístup ku všetkým zadaniam.`,
    homeCarouselTitle3: "Oslobodenie času",
    homeCarouselDescription3: `Predstavte si vzácne hodiny, ktoré by ste mohli získať späť na expanziu podnikania, 
    uprednostnenie kľúčových činností alebo dokonca doprianie si zaslúženého osobného času. Využitím mojich služieb môžu 
    podnikatelia odomknúť množstvo času a presmerovať ho na to, na čom skutočne záleží.`,
    homeCarouselTitle4: "Finančná efektívnosť",
    homeCarouselDescription4: `Jedným z najatraktívnejších aspektov práce s virtuálnym asistentom je efektívnosť nákladov. 
    S virtuálnym asistentom platíte len za konkrétne služby, ktoré požadujete. Rozlúčte sa s výdavkami súvisiacimi s daňami, 
    kancelárskym vybavením a školením. V porovnaní s prijatím zamestnanca sa dodatočné režijné náklady rozplynú, keďže sa o všetko postaráme samostatne.`,
    homeCarouselTitle5: "Prevencia vyhorenia - 'Burnout'",
    homeCarouselDescription5: `Podnikatelia často čelia ohromnej výzve žonglovať s viacerými prioritami, takže sú náchylní na vyhorenie. 
    Zadajte virtuálneho asistenta, ktorý je riešením tohto problému. Ak mi zveríte svoju pracovnú náplň, môžete sa oslobodiť a sústrediť sa výlučne na úlohy, 
    ...
    administrationText: `Ponuka našich služieb zahŕňa napríklad: Vyhľadávanie informácií online, Správa dát, 
    Správa kalendára, Úprava dokumentov, Reporty, Prieskum trhu, Spracovanie dokumentov, Zadávanie údajov do systému.`,
    administrationFoot: 'Dajte mi vedieť, ako Vám môžem pomôcť!',

    social: 'Správa sociálnych sieti',
    socialSubtitle: `Ak nemáte čas na správu svojich sociálnych sietí, rada by som Vám ponúkla svoje služby v oblasti grafického a textového spracovania príspevkov. 
    Moje príspevky budú zamerané na zaujatie Vašej cieľovej skupiny a tiež prilákanie nových klientov.`,
    socialText: `Tvorba príspevkov, príbehov, reels. Návrh marketingovej stratégie, 
    predajná komunikácia služieb či produktov, interakcia so zákazníkmi, organizacia súťaží, odpovedanie na správy a komentáre.`,
    socialFoot: '',
    ...
    graficSubtitle: `Bez ohľadu na to, či potrebujete profesionálne logo na mieru alebo dizajn pre pozvánky, 
    letáky, vizitky, oznámenia alebo jedálny lístok či cenník do kozmetického salónu, som tu pre Vás. 
    Stačí mi poskytnúť podrobnosti o Vašich požiadavkách a môžeme začať pracovať na vytvorení profesionálneho dizajnu, ktorý vyhovuje Vašim potrebám.`,
    graficText: `Logo, Dizajn obalov a produktov, Digitálne produkty, Marketingové materiály, Tlačoviny, 
    Reklamné materiály (bannery), Plagáty do podniku/na event, Jedálne a nápojové lístky, Cenníky, Pozvánky na udalosti, 
    Oznámenia, Návrh príspevkov na FB/IG, Úprava fotiek, videí, vkladanie tituliek`,
    graficFoot: '',

    texts: 'Texty a preklady',
    textsSubtitle: `Ak sa vám zdá ťažké poradiť si s textami alebo prekladmi, nechajte to na nás.
    Či už potrebujete texty na web, reklamu alebo potrebujete vytvoriť skript na oslovovanie klientov.
    Okrem bežných prekladov ako magister z molekulárnej biológie ponúkam aj preklady odborných biologických textov pre vaše publikácie,
    alebo pomoc s prípravou dokumentov, rešeršemi v literatúre a jazykovými korektúrami.`,
    textsText: `Tvorba a plánovanie obsahu, článkov, textovania príspevkov (úprava článkov a druhé oči v prípade možných chýb vo vašom texte),
    grafika, prepisovanie (dokumentov, podcastov alebo videonahrávok), vytváranie prehľadných tabuliek alebo databáz zákazníkov`,
    textsFoot: '',
    ...
    luckyText: `Ak máte iné úlohy alebo projekty, neváhajte ma kontaktovať a dohodneme si bezplatnú úvodnú konzultáciu. 
    Počas konzultácie sa môžeme porozprávať o Vašich potrebách a zistiť, či a ako by som Vám mohla pomôcť.`,
    luckyFoot: '',
    ...
    priceText2: {
      p1: `Ak ste v mojom cenníku virtuálnej asistentky nenašli balík, ktorý by vyhovoval Vašim potrebám, 
      viem Vám pripraviť individuálny balíček služieb, ktorý bude úplne prispôsobený Vašim požiadavkám.`,
    },
    ...
    aboutTitle: '',
    aboutText1: {
      p1: `Kedysi dávno som sa ocitol v korporátnom svete, pričom som si počínal dobre v back-office práce, ktorá mi umožňovala prosperovať s minimálnym dohľadom. 
      Život bol dobrý, kým neprišiel nový manažér, ktorý so sebou priniesol štýl mikromanažmentu, ktorý udusil moju nezávislosť a kreativitu.`,
      p2: `Vtedy som vedel, že sa musím oslobodiť. Vydal som sa na hľadanie práce, ktorá by mi dala slobodu, po ktorej som túžila. 
      Preskakoval som z jednej spoločnosti do druhej, neustále som sa učil a rýchlo sa prispôsoboval novým rolám. Ale niečo tomu chýbalo. 
      Svoju prácu by som dokončil rýchlosťou blesku, len aby mi zostali prázdne a všedné hodiny. Nemohol som sa zbaviť pocitu, že môžem dať oveľa viac.`,
      p3: `A potom ma to napadlo: Prečo nezobrať veci do vlastných rúk? Urobil som odvážne rozhodnutie stať sa samostatne zárobkovo činnou osobou a veril som, 
      že moje schopnosti prekvitajú pri pomoci podnikom rásť.`,

    },
    aboutText2: {
      p1: `Ako virtuálny asistent nie som len ďalšou tvárou v korporátnom stroji. Som tu, aby som vám ponúkol osobný kontakt, skutočné spojenie a oddanosť vášmu úspechu. 
      Chcem byť viac než len poskytovateľom služieb; Chcem byť tvojím dôveryhodným partnerom.`,
      p2: `Keď sa rozhodnete so mnou pracovať, nenajímate si bezmennú entitu alebo organizáciu bez tváre. 
      Vyberáte si niekoho, kto rozumie výzvam a frustráciám vyplývajúcim z obmedzenia v tradičnom pracovnom prostredí. 
      Vyberáte si niekoho, kto verí, že skutočný úspech spočíva v slobode objavovať, tvoriť a mať zmysluplný vplyv.`,
      p3: `Prenesiem svoju efektívnosť, vynaliezavosť a vášeň, aby ste sa mohli sústrediť na to, 
      čo robíte najlepšie, pričom viete, že administratívna stránka je v rukách odborníkov.`,
  ...
  cs: {
    ...
    homeText: {
      p1: `Zahlcují vaše podnikání administrativní úkoly? Stává se vám zdrcující držet krok s kontrolami a aktualizacemi dat, 
      údržbou poštovních schránek a sociálními médii? Už nehledejte! Jsem tu, abych vám poskytl správná řešení, která posunou vaše podnikání správným směrem.`,
      ...
      p3: `Se svými odbornými znalostmi virtuálního asistenta se specializuji na vyřizování administrativních úkolů, 
      které zajišťují hladké a efektivní fungování vaší firmy. Potřebujete někoho, kdo by pečlivě zkontroloval a aktualizoval vaše data? 
      Mám vás k dispozici. Už vás nebaví žonglovat s více poštovními schránkami a snažit se udržet si přehled o zákaznických dotazech? Nechte to na mně. 
      Chcete si vybudovat silnou online přítomnost prostřednictvím sociálních sítí, ale chybí vám to hotové?`,
      p4: `Ale jsem víc než jen poskytovatel řešení. Jsem váš oddaný partner v úspěchu. Když se mnou budete spolupracovat, získáte přístup k někomu, 
      komu na vašem podnikání skutečně záleží. Věnuji čas tomu, abych porozuměl vašim jedinečným potřebám, cílům a identitě značky a zajistil, že mé služby budou dokonale odpovídat vaší vizi.`,
      p5: `Představte si, že máte více času a klidu s vědomím, že vaše administrativní úkoly jsou zpracovány bezchybně. Představte si, že vaše podnikání vzkvétá, 
      když odborně spravuji vaše data, udržuji vaše e-mailové schránky organizované a vytvářím poutavý obsah na sociálních sítích.`,
      p6: `Takže, jste připraveni posunout své podnikání do nových výšin? Vydejme se na tuto cestu společně. Kontaktujte mě ještě dnes a prodiskutujeme, 
      jak moje řešení na míru mohou posouvat vaše podnikání vpřed. Váš úspěch je mou vášní a nemůžu se dočkat, až budu jeho součástí.`,
    },
    ...
    homeCarouselDescription1: `Jsem neochvějný ve svém závazku k dokonalosti a důsledně se snažím zajistit, aby vaše úkoly byly dokončeny nejen včas, ale také s přesností. 
    Můžete se na mě spolehnout, že dodám vynikající výsledky a nenechám žádný prostor pro pochybnosti nebo zklamání.`,
    homeCarouselTitle2: "Nezávislost",
    homeCarouselDescription2: `Přijímám věčnou cestu sebezdokonalování, neustále se zapojuji do učení a navštěvuji kurzy, abych zdokonalil své dovednosti. 
    Moje pečlivá pozornost k detailu zajišťuje komplexní a důkladný přístup ke všem úkolům.`,
    homeCarouselTitle3: "Osvobození času",
    homeCarouselDescription3: `Představte si ty vzácné hodiny, které by bylo možné získat zpět na obchodní expanzi, upřednostnění klíčových 
    činností nebo dokonce dopřát si zasloužený osobní čas. Využitím mých služeb mohou podnikatelé odemknout spoustu času a přesměrovat ho k tomu, na čem skutečně záleží.`,
    homeCarouselTitle4: "Finanční efektivita",
    homeCarouselDescription4: `Jedním z nejatraktivnějších aspektů práce s virtuálním asistentem je hospodárnost. S virtuální asistentkou platíte pouze za konkrétní služby, 
    které požadujete. Rozlučte se s výdaji souvisejícími s daněmi, kancelářským vybavením a školením. V porovnání s najímáním zaměstnance se 
    dodatečné režijní náklady rozplynou v netuctovém vzduchu, protože je vše řešeno samostatně.`,
    homeCarouselTitle5: "Prevence vyhoření - 'Burnout'",
    homeCarouselDescription5: `Podnikatelé často čelí obrovské výzvě žonglování s více prioritami, takže jsou náchylní k vyhoření. 
    Vstupte do virtuálního asistenta, řešení právě tohoto problému. Tím, že mi svěříte svou pracovní zátěž, se můžete uvolnit a soustředit se pouze na úkoly, 
    které vyžadují vaši jedinečnou profesionální odbornost.`,
    ...
    administrationText: `Nabídka našich služeb zahrnuje například: Vyhledávání informací online, Správa dat, 
    Správa kalendáře, Úprava dokumentů, Reporty, Průzkum trhu, Zpracování dokumentů, Zadávání údajů do systému.`,
    administrationFoot: 'Dejte mi vědět, jak Vám můžu pomoci!',


    social: 'Správa sociálních sítí',
    socialSubtitle: `Pokud nemáte čas na správu svých sociálních sítí, ráda bych Vám nabídla své služby v oblasti grafického a textového zpracování příspěvků. 
    Moje příspěvky budou zaměřeny na zaujetí Vaší cílové skupiny a také přilákání nových klientů.`,
    socialText: `Tvorba příspěvků, příběhů, reels. Návrh marketingové strategie, prodejní komunikace služeb či produktů, 
    interakce se zákazníky, organizace soutěží, zodpovězení zpráv a komentářů.`,
    socialFoot: '',
    ...
    graficSubtitle: `Bez ohledu na to, zda potřebujete profesionální logo na míru nebo design pro pozvánky, letáky, vizitky, oznámení 
    nebo jídelníček či ceník do kosmetického salonu, jsem tady pro Vás. Stačí mi poskytnout podrobnosti o vašich požadavcích a můžeme začít pracovat 
    na vytvoření profesionálního designu, který vyhovuje vašim potřebám.`,
    graficText: `Logo, Design obalů a produktů, Digitální produkty, Marketingové materiály, Tiskoviny, Reklamní materiály (bannery), 
    Plakáty do podniku/na event, Jídelní a nápojové lístky, Ceníky, Pozvánky na události, Oznámení, Návrh příspěvků na FB/IG, Úprava fotek , videí, vkládání titulek`,
    graficFoot: '',

    texts: 'Texty a překlady',
    textsSubtitle: `Pokud je pro vás obtížné vypořádat se s texty nebo překlady, nechte to na nás.
    Ať už potřebujete texty na web, do reklamy nebo potřebujete vytvořit skript pro oslovování klientů.
    Kromě běžných překladů jako magistra molekulární biologie nabízím také překlady odborných biologických textů pro vaše publikace,
    nebo pomoc s přípravou dokumentů, rešeršemi v literatuře a jazykovými korekturami.`,
    textsText: `Tvorba a plánování obsahu, článků, textování příspěvků (editace článků a druhé oči v případě možných chyb ve vašem textu),
    grafika, přepisování (dokumentů, podcastů nebo videonahrávek), vytváření přehledných tabulek nebo zákaznických databází`,
    textsFoot: '',
    ...
    luckyText: `Pokud máte jiné úkoly nebo projekty, neváhejte mě kontaktovat a domluvíme si bezplatnou úvodní konzultaci. 
    Během konzultace si můžeme popovídat o Vašich potřebách a zjistit, zda a jak bych Vám mohla pomoci.`,
    luckyFoot: '',
    ...
    priceText2: {
      p1: `Pokud jste v mém ceníku virtuální asistentky nenašli balíček, který by vyhovoval Vašim potřebám, 
      umím Vám připravit individuální balíček služeb, který bude zcela přizpůsoben Vašim požadavkům.`,
    },
    ...
    aboutTitle: '',
    aboutText1: {
      p1: `Kdysi dávno jsem zjistil, že jsem uvězněn v korporátním světě, dařilo se mi dobře v back-office práci, která mi umožňovala prosperovat s minimálním dohledem. 
      Život byl dobrý, dokud nepřišel nový manažer, který s sebou přinesl styl mikrořízení, který udusil moji nezávislost a kreativitu.`,
      p2: `Tehdy jsem věděl, že se musím osvobodit. Šel jsem hledat práci, která by mi dala svobodu, po které jsem toužil. 
      Přeskakoval jsem z jedné společnosti do druhé, neustále jsem se učil a rychle se přizpůsoboval novým rolím. Ale něco tomu chybělo. 
      Svou práci bych dokončil rychlostí blesku, jen aby mi zůstaly prázdné a všední hodiny. Nemohl jsem se zbavit pocitu, že toho můžu dát mnohem víc.`,
      p3: `A pak mě to napadlo: Proč nevzít věci do vlastních rukou? Učinil jsem odvážné rozhodnutí stát se osobou samostatně výdělečně činnou, 
      protože jsem věřil, že mé dovednosti rozkvetou a pomohou firmám růst.`,

    },
    aboutText2: {
      p1: `Nyní, jako virtuální asistent, nejsem jen další tváří ve firemním stroji. 
      Jsem tu, abych vám nabídl osobní přístup, skutečné spojení a odhodlání vašemu úspěchu. 
      Chci být víc než jen poskytovatel služeb; Chci být tvým důvěryhodným partnerem.`,
      p2: `Když se rozhodnete se mnou pracovat, nenajímáte si bezejmennou entitu nebo organizaci bez tváře. 
      Vybíráte si někoho, kdo rozumí výzvám a frustracím vyplývajícím z omezení v tradičním pracovním prostředí. 
      Vybíráte si někoho, kdo věří, že skutečný úspěch spočívá ve svobodě zkoumat, tvořit a mít smysluplný dopad.`,
      p3: `Představím svou efektivitu, vynalézavost a vášeň, takže se můžete soustředit na to, 
      co umíte nejlépe, a přitom vědět, že administrativní stránka je v rukou odborníků.`,
